    ...
    try {
        ...
        const partyFeed = partyPlans.map(p => {
            ...
            return {
                ...
                venue: (p as any).venue,
                venueImageUrl: (p as any).venue?.images?.[0]?.filePath ?? (p as any).venue?.coverImageUrl ?? (p as any).venue?.imageUrl ?? null,
                coverImageUrl: (p as any).venue?.images?.[0]?.filePath ?? (p as any).venue?.coverImageUrl ?? (p as any).venue?.imageUrl ?? null,
