                              ...
                              child: TextField(
                                ...
                                onChanged: (value) {
                                    if (value.isNotEmpty) {
                                      ...
                                      if (parsed > maxGuests) {
                                        parsed = maxGuests;
                                        _friendsController.text = maxGuests.toString();
                                        _friendsController.selection = TextSelection.fromPosition(
                                          TextPosition(offset: maxGuests.toString().length),
                                        );
                                        ScaffoldMessenger.of(context).showSnackBar(
                                          SnackBar(
                                            content: Text('Maximum $maxGuests friends allowed'),
                                          ),
                                        );
                                      }
                                    setState(() {
                  ...
                  Container(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        prefixIcon: const Icon(Icons.phone, color: LunaraTheme.electricViolet, size: 20),
                        border: InputBorder.none,
                  ...
                  Container(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintStyle: TextStyle(color: Colors.grey[400], fontSize: 13),
                        prefixIcon: const Icon(Icons.phone_android, color: LunaraTheme.electricViolet, size: 20),
                        border: InputBorder.none,
                        contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 14),
                      ),
                    ),
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (_) => PaymentConfirmationScreen(
                              ...
                              optionalMobileNumber: _optMobileController.text.trim(),
                            ),
                          ),
                        );
                      },
