    ...
    public static async enrichGroupPartyNotificationCard(partyId: string, _recipientUserId: string, preloadedGp?: any): Promise<any | null> {
        try {
            ...
            return {
                ...
                requiresAction: Boolean(!isConfirmed && isApproved && !isExpired && !isCancelled),
                read: false,
                isRead: false,
                category: 'bookings',
    ...
    public static async enrichLargePartyNotificationCard(bookingId: string, _recipientUserId: string): Promise<any | null> {
        try {
            ...
            return {
                ...
                updatedAt: updatedIso,
                lastActivityAt: updatedIso,
                requiresAction: Boolean(isPaymentPending || (isApproved && !isPaymentConfirmed && !isExpired && !isRejected)),
                read: false,
                isRead: false,
                category: 'bookings',
